...
function updateProjectControls(){
 ...
 const paths=[...folderHandlesByPath.keys()].filter(projectIncludes).sort((a,b)=>a.localeCompare(b,'nl'));
 target.replaceChildren(...paths.map(p=>new Option(p,p)));if(paths.includes(previous))target.value=previous;
